...
inits <- function(){list(
  ...
  mphi= matrix(nrow = 2, ncol = 2, data = rep(.35,4)),
...
poptrendspast
ggsave("output/Past_population_trajectories_v12.jpg", width=241,height=191, quality=100, units="mm")
...
ggsave("output/Extinction_probability_v12.jpg", width=351,height=191, quality=100, units="mm")
...
ggsave("output/Future_pop_growth_rates_v12.jpg", width=235,height=181, quality=100, units="mm")
