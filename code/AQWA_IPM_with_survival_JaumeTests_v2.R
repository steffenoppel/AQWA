...
sink("models/AQWA.IPM.surv.Scenarios.v5.jags")
cat("
model {
...
ipm.model <- jags(jags.data,
                  inits,
                  parameters,
                  "models/AQWA.IPM.surv.Scenarios.v5.jags",
...
poptrendspast
ggsave("output/Past_population_trajectories_v2.jpg", width=241,height=191, quality=100, units="mm")
...
poptrends <- 
  ...
  xlab("Year") + ylab("Aquatic Warbler population size")
poptrends
ggsave("output/Scenario_projections_v2.jpg", width=241,height=191, quality=100, units="mm")
...
ggsave("output/Extinction_probability_v2.jpg", width=351,height=191, quality=100, units="mm")
...
ggsave("output/Future_pop_growth_rates_v2.jpg", width=235,height=181, quality=100, units="mm")
...
write.table(out, "output/AQWA_GER_model_nscenarios_output.v5.csv", sep=",")
