...
ipm.model2 <- update(ipm.model, n.iter = 50000, n.thin = 50)
ipm.model3 <- update(ipm.model2, n.iter = 125000, n.thin = 100)
...
# 
# plot(ipm.model$mean$mfec1, type = "l", col = "red", ylim = c(1.5,5.6), lwd = 2, xlab = "Year", ylab = "Estimate", main = "First-year productivity")
# lines(ipm.model$q2.5$mfec1, lty = "dashed", lwd = 1.5, col = "red")
# lines(ipm.model$q97.5$mfec1, lty = "dashed", lwd = 1.5, col = "red")
# abline(v = ny, lty = "dashed")
# 
# #Second-year productivity
# 
# plot(ipm.model$mean$mfec2, type = "l", col = "red", ylim = c(0.7,3.2), lwd = 2, xlab = "Year", ylab = "Estimate", main = "Second-year productivity")
# lines(ipm.model$q2.5$mfec2, lty = "dashed", lwd = 1.5, col = "red")
# lines(ipm.model$q97.5$mfec2, lty = "dashed", lwd = 1.5, col = "red")
# abline(v = ny, lty = "dashed")
# 
