...
sink("models/AQWA.IPM.surv.Scenarios.v4.beta.jags")
cat("
model {
...
ipm.model <- jags(jags.data,
                  inits,
                  parameters,
                  "models/AQWA.IPM.surv.Scenarios.v4.beta.jags",
...
write.table(out, "output/AQWA_GER_model_nscenarios_output.v4.beta.csv", sep=",")
